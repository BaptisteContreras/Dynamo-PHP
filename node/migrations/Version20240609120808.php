...
final class Version20240609120808 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE history_event (id UUID NOT NULL, node UUID NOT NULL, type INT NOT NULL, event_time TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, data TEXT NOT NULL, source_node UUID DEFAULT NULL, received_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
