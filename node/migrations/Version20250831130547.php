 ...
 */
final class Version20250831130547 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE item (id UUID NOT NULL, key TEXT NOT NULL, ring_key INT NOT NULL, data TEXT NOT NULL, version JSON NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, owner UUID NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN item.owner IS \'(DC2Type:uuid)\'');
